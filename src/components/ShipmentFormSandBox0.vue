  ...
  <div>
    ...
    <form @submit.prevent="sendForm">
      <fieldset>
        ...
        <BaseInput v-model="shipTo.address1" label="Address 1" type="text" />

        <BaseInput v-model="shipTo.address2" label="Address 2" type="text" />
      ...
      <fieldset>
        ...
        <BaseInput
          ...
          type="number"
        />
        <BaseInput v-model="packageOptions.width" label="Width" type="number" />
        <BaseInput
